...
export function createFlightRoutes(
  ...
  const lineMat = new THREE.ShaderMaterial({
    ...
    uniforms: {
      uTime: { value: 0 },
      uCameraDistance: { value: 25 },
      uHeadColor: { value: GOOGLE_COLORS.yellow.clone() },
      uTailColor: { value: GOOGLE_COLORS.yellow.clone() },
      uBaseColor: { value: GOOGLE_COLORS.yellow.clone() },
      uAccentColor: { value: GOOGLE_COLORS.yellow.clone() },
